...
SECRET_KEY = 'django-insecure-p3^&n&nd(x%jkff32*h(f+v_%%gq41pzq9!4p0+m19w8lgz+3d'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'marketplace.context_processors.marketplace_categories',
            ],
        },
    },
]
...
if bool(os.environ.get('DB_USE_MYSQL', False) == '1') is True:
    DATABASES = {
        'default': {
